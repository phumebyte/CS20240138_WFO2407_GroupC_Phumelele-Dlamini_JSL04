...
const userPreferenceTernary = userPreference ? userPreference : 'Regular'
console.log(userPreferenceTernary);
...
const cansTernary = cansLeft < 5 ? "Time to restock!" : "We're stocked!"
console.log(cansTernary); // ternary statement evaluates a boolean value and compares 3 < 5?
...
const heartTernary = heartRate < 100 ? "Boost needed!" : "Energy levels are high!"
console.log(heartTernary);
...
const currentTempTernary = currentTemp <= 5 ? "Chilled to perfection!" : "Needs a cooler!"
console.log(currentTempTernary);
...
const currentHourTernary = currentHour >= 7 && currentHour < 24 ? "Unleash the beast!" : "Better stick to water."
console.log(currentHourTernary);
